    ...
    <div class="container">
      ...
      <div class="footer-content">
        ...
        <div class="footer-links" data-aos="fade-up" data-aos-delay="200">
          <h3 class="footer-title">Nawigacja</h3>
          <ul class="footer-nav">
            <li><a href="/"><span class="nav-dot"></span>Strona Domowa</a></li>
            <li><a href="/features"><span class="nav-dot"></span>Co oferujemy</a></li>
            <li><a href="/join"><span class="nav-dot"></span>Jak dołączyć</a></li>
            <li><a href="/staff"><span class="nav-dot"></span>Zespół</a></li>
            <li><a href="/rules"><span class="nav-dot"></span>Zasady</a></li>
          </ul>
        </div>
        ...
        <div class="footer-services" data-aos="fade-up" data-aos-delay="300">
          ...
          <ul class="footer-nav">
            ...
            <li><a href="#"><span class="nav-dot"></span>Domy Graczy</a></li>
          </ul>
        </div>
      ...
      <div class="footer-bottom">
        <p class="copyright">© 2025 <span>AetherRP.</span> Wszystkie prawa zastrzeżone.</p>
        <div class="footer-legal">
          <a href="/rules">Zasady Serwera</a>
          <span class="legal-separator">•</span>
          <a href="/join">Jak dołączyć</a>
        </div>
      </div>
